      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 md:gap-12">
        <div className="col-span-1 sm:col-span-2 md:col-span-1">
          ...
          <div className="flex space-x-4 mt-6">
            ...
            <a href={`https://wa.me/918340110200?text=${encodeURIComponent("Hello Mangal Guruji Foundation! I would like to know more about how I can support your initiatives.")}`} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#25D366] transition-colors" aria-label="WhatsApp">
