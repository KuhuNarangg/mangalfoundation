      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 md:gap-12">
        <div className="col-span-1 sm:col-span-2 md:col-span-1">
          ...
          <div className="flex space-x-4 mt-6 items-center">
            ...
            <a href={`https://wa.me/918340110200?text=${encodeURIComponent("Hello Mangal Guruji Foundation! I would like to know more about how I can support your initiatives.")}`} target="_blank" rel="noreferrer" className="flex items-center justify-center w-8 h-8 rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-[0_0_15px_rgba(37,211,102,0.5)] transition-all duration-300 hover:scale-110" aria-label="WhatsApp">
