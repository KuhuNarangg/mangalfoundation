...
export function Hero() {
  ...
  // Fade out B&W and fade in Color over the entire scroll range
  ...
  const text1Y = useTransform(scrollYProgress, [0, 0.5], [0, -50]);

  // Second text fades in late
  const text2Opacity = useTransform(scrollYProgress, [0.4, 1], [0, 1]);
  const text2Y = useTransform(scrollYProgress, [0.4, 1], [50, 0]);
