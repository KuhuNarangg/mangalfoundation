...
export function Hero() {
  ...
  const text2Opacity = useTransform(scrollYProgress, [0.2, 0.6], [0, 1]);
  const text2Y = useTransform(scrollYProgress, [0.2, 0.6], [50, 0]);

  return (
    <div ref={containerRef} className="relative h-[200vh] md:h-[400vh]">
